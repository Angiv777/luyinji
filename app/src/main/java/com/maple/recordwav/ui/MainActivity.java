...
public class MainActivity extends FragmentActivity {
    ...
    private void initTitleBar() {
        binding.tvTitle.setText("Wav 助手");
        binding.tvSwitch.setText(" ");
    }

    private void initView() {
        List<Fragment> fragmentList = new ArrayList<Fragment>();
        Fragment tab0 = getSupportFragmentManager().findFragmentByTag(FragmentChangeManager.getFragmentTag(0));
        fragmentList.add(tab0 != null ? tab0 : new RecordPage());
        Fragment tab1 = getSupportFragmentManager().findFragmentByTag(FragmentChangeManager.getFragmentTag(1));
        fragmentList.add(tab1 != null ? tab1 : new PlayParsePage());
        Fragment tab2 = getSupportFragmentManager().findFragmentByTag(FragmentChangeManager.getFragmentTag(2));
        fragmentList.add(tab2 != null ? tab2 : new PlayParsePage());
        ...
        new RxPermissions(this).request(
            ...
            if (!granted) {
                new AlertDialog(MainActivity.this)
                        ...
                        .setLeftButton("退出", v -> MainActivity.this.finish())
